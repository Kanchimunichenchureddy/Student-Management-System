...
import logging
from fastapi import APIRouter, Depends, HTTPException, status #fastapi is a web framework for building APIs
from sqlalchemy.orm import Session #sqlalchemy is a library for interacting with databases
